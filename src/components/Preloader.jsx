    ...
    >
      {!showHello ? (
        <div className="flex flex-col items-center justify-center animate-in fade-in duration-300">
          ...
          {/* Large Bold Percentage (Screenshot 1) */}
          <div
            ref={textRef}
          ...
          {/* Curved Circular Pencil Loader matching Screenshot 1 */}
        ...
        /* OFFICIAL APPLE HELLO ANIMATION (Gentle, moderate, ultra-smooth handwriting pace) */
        <div className="flex flex-col items-center justify-center px-4 animate-in fade-in duration-400">
          <div className="relative w-[320px] sm:w-[560px] h-[120px] sm:h-[190px] flex items-center justify-center">
            ...
            >
              ...
              {/* Path 2: h2 + ello (Arch of h, loop of e, tall parallel loops of ll, and curl of o) */}
              <path
